...
VALUES
(@JohnDoeUserId, 1, 'John Doe', 78, 'john@doe.com', '0123123230922', '0123456789'),
(@JohnDoeSegundoUserId, 1, 'John Doe', 78, 'john1@doe.com', '0123123230923', '0123456788'),
(@JohnDoeTerceroUserId, 1, 'John Doe', 78, 'john2@doe.com', '0123123230924', '0123456787');

SELECT * FROM Usuarios

INSERT INTO Usuarios (TipoId, Nombre, Edad, Correo, NumeroDeTelefono, Cedula)
VALUES
(1, 'John Doe', 78, 'john4@doe.com', '0123123230926', '0123456786');

-- forma de llamar a los id's sin usar select
